...
final class LocalMeetingWaveFileWriter {
    ...
    private func makeHeader(dataSize: UInt32) -> LocalMeetingWaveHeader {
        LocalMeetingWaveHeader(
            chunkID: ("R", "I", "F", "F"),
    ...
    private func pcmHeaderData(from header: LocalMeetingWaveHeader) -> Data {
        var data = Data()
...
private struct LocalMeetingWaveHeader {
